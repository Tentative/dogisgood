          ...
          <v-col :cols="12" md="6" xs="12">
            <div class="text-center">
              <v-sheet id="main-content" color="#aae56d"
                ...
                proprietario imparano, insieme, gli esercizi di base utili nella
                vita quotidiana, come la condotta al guinzaglio e il richiamo,
                ma soprattutto a relazionarsi nel migliore dei modi, a risolvere
                piccoli e grandi problemi ed avere così una vita insieme più
                felice e semplice per entrambi.
              </v-sheet>
            </div>
          </v-col>
          <v-col :cols="12" xs="12" md="6" style="height:100%">
            ...
            >
              <v-card-subtitle class="headline font-weight-bold"
                ...
                migliore consulenza, competente e attenta, che ti guidi in un
                percorso di adozione maturo e responsabile..</v-card-subtitle
              >
            </v-card>
          </v-col>
        </v-row>
